function [model,rxnIDexists] = addReaction_EGC(model,rxnName,metaboliteList,stoichCoeffList,revFlag,lowerBound,upperBound,objCoeff,subSystem,grRule,geneNameList,systNameList,checkDuplicate,confScores)
...
if (rxnInModel)
    ...
    model=removeRxns(model,rxnName); % Modified by Gaby Jan 28th 2025
    model.c(findRxnIDs(model,modelOrig.rxns{rxnIDexists}))=1; % Modified by Gaby Jan 28th 2025
    ...
    model.c(findRxnIDs(model,rxnName))=1;% Modified by Gaby Jan 28th 2025
